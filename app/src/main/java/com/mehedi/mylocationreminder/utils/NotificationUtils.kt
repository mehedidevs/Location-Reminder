package com.mehedi.mylocationreminder.utils
...
import com.mehedi.mylocationreminder.locationreminders.ReminderDescriptionActivity
...
fun sendNotification(context: Context, reminderDataItem: ReminderDataItem) {
    val NOTIFICATION_CHANNEL_ID = context.packageName + ".chanel"
